...
public class B_KeyboardInput {
	...
	public void inputTest() {
		...
		System.out.println("입력받은 내용 : " + typeIn);
	...
	public void inputTest2() {
		...
		//		   (따라서 거주지라던가 등등 이런 내용 같은 경우 공백이 있을 수 있기 때문에 제대로 된 값을 못가져올 수 있음)
	...
	public void inputTest3() {
		...
		sc.nextLine();
		//결론 : sc.nextXXXX() 메소드 뒤에 sc.nextLine() 메소드가 오게될 경우 버퍼에 남아있는 '엔터'를 비워주는 과정 필수!!
		...
		System.out.printf("%s님은 %d살이며, 사는 곳은 %s이고, 키는 %.2f 입니다.", name, age, address, height);
	}
	
	public void inputTest4() {
		Scanner sc = new Scanner(System.in);
		
		// 문자열을 입력받을때 => sc.nextLine()
		...
		//char gender = sc.nextChar(); // nextChar는 존재하지 않음
		char gender = sc.nextLine().charAt(0); 
		// 문자열.charAt(인덱스) : 해당 문자열로부터 해당 인덱스의 문자를 추출해주는 메소드
		// ** 인덱스 :순번 같은존재. 단, 0부터 시작함!!
	...
	public void charAtTest() {
		...
		//System.out.println(str.charAt(10)); //StringIndexOutOfBoundsException 발생
		
 	}
	
	/*
	 * ** 정리 **
	 * 1. 콘솔창(모니터)에 출력하기위해 : System.out.print[ln]()메소드 이용
