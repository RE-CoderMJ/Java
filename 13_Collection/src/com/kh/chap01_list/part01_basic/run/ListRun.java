...
public class ListRun {
	 ...
	 * 
	 * 	 2. 배열의 중간 위치에 추가한다거나 삭제하는 경우 값을 매번 땡겨주는 복잡한 알고리즘을 직접 기술해야함
	 *
	 *	 3. 한 공간에 한 타입의 데이터들만 저장 가능하다.
	 *
	 * 
	 * > 컬렉션의 장점
	 * 	 1. 크기 지정해줄 필요 없음! 만일 지정했다고 해도 더 많은 데이터들이 들어오면 알아서 사이즈 늘려줌
	 * 		크기의 제약이 없다. 
	 * 
	 * 	 2. 중간에 값을 추가한다거나 삭제하는 경우 값을 땡겨주는 작업(알고리즘)을 직접 기술할 필요없음!!
	 * 		단지 메소드 호출만으로 알아서 내부적으로 진행될꺼임
	 * 
	 * 	 3. 한 공간에 여러타입의 데이터들 저장 가능!! (단, 객체만 저장 가능)
	 * 		한 타입만 담기도록 제한을 둘 수도 있음!
	 * 
	 * * 방대한 데이터들을 단지 보관만 해두고 조회만 할 경우 배열을 많이 사용
	 * 	  방대한 데이터들을 보관, 추가, 삭제 등등 이런 과정들이 빈번할경우 컬렉션을 많이 사용
	 * 
	 * 
	 *   // 그림부분 영상 다시보자!
	 *   
	...
	public static void main(String[] args) {
		...
		ArrayList/*Object*/ list = new ArrayList(3); // 크기 지정할수도 있고 안할수도 있음!!
		...
		System.out.println(list); // list의 특징 : 순서유지 하면서 담김 (0번 인덱스부터 차곡차곡)
		...
		// 4. set(int index, E e) : 해당 인덱스위치에 데이터를 새로인 전달된 e로 수정시켜주는 메소드
